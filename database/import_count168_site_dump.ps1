# Convert a Hostinger count168 dump for count168_site and import into local/production MySQL.
# Usage:
#   .\import_count168_site_dump.ps1 -InputPath "C:\Users\User\Downloads\u857194726_count168 (1).sql"
#   .\import_count168_site_dump.ps1 -InputPath "..." -SkipImport
...
param(
    ...
    [string] $DbUser = 'root',
    [string] $DbPass = '',
    [string] $DbName = 'u857194726_count168_site',
    [switch] $SkipImport
)
...
$outDir = $PSScriptRoot
$prepared = Join-Path $outDir 'count168_site_import_prepared.sql'

Write-Host "Preparing dump for ``$DbName`` (strip DEFINER, fix collation)..."
...
while ($null -ne ($line = $reader.ReadLine())) {
    ...
    $line = $line.Replace('u857194726_count168', 'u857194726_count168_site')
