...
function updateIdProductDisplay(row) {
...
function getSummaryRowKey(row) {
    ...
    const idProduct = normalizeIdProductForKey(rawIdProduct);
...
async function initTable() {
    const data = await fetchYourData(); // 你的数据

    renderTable(data); // 先画表

    fixAllIdProductDisplay(); // ✅ 再补 description
