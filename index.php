...
if (isset($_SESSION['user_id'])) {
    if (isset($_SESSION['user_type']) && strtolower((string) $_SESSION['user_type']) === 'member') {
        ...
        if ($requestPath === '/login' || $requestPath === '/dashboard' || $requestPath === '/domain' || $requestPath === '/announcement' || $requestPath === '/admin') {
            serveSpaIndex();
        }
...
if ($requestPath === '/dashboard' || $requestPath === '/domain' || $requestPath === '/announcement' || $requestPath === '/admin') {
