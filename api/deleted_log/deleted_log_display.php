...
function deleted_log_display_page_label(string $page): string
{
    ...
    $map = [
        ...
        '/api/bankprocess_maintenance/delete_api.php' => '银行流程维护 Bank Process Maintenance',
        '/api/capture_maintenance/delete_api.php' => '抓数维护 Capture Maintenance',
        ...
        '/api/subscription/auto_renew_api.php' => '自动续费 Auto Renew',
        '/api/maintenance/delete_api.php' => '系统维护跑马灯 Announcement / Marquee',
