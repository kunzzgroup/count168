...
// 检查用户是否已登录（对于需要权限的操作）
if (in_array($action, ['list', 'create', 'update', 'delete', 'validate_domain_code', 'get_domain_fee_settings', 'save_domain_fee_settings', 'get_company_share_settings', 'save_company_share_settings', 'save_group_tenant_settings'], true)) {
