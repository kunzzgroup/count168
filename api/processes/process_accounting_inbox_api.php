 ...
 * - Bank 表单 Day end 仅由前端 autoCalculateBankDayEnd / contractBillingEndYmdForBankForm 自动填（起租 1 号时与 exclusive 对齐）；入账与 isWithinRecurringBillingWindow 仍以本文件 PHP 为准。
