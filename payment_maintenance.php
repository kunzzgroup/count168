    ...
    <div class="container">
        ...
        <div class="maintenance-search-section">
            <div class="maintenance-filters">
                ...
                <div class="maintenance-form-group maintenance-search-inline">
                    <label class="maintenance-label" for="filter_search">Search</label>
                    <div class="search-container maintenance-search-container">
                        ...
                        <input type="text" id="filter_search" placeholder="Account, description, submitter..." class="search-input maintenance-search-input" autocomplete="off">
                    </div>
                </div>
