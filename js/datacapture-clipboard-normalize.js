/** Material mat-row clipboard normalize (PHP datacapture) */
(function (global) {
'use strict';
/**
...
const GRID_HINT_RE =
  /mat-row|mat-cell|mat-header-row|mat-header-cell|mat-footer-cell|cdk-row|cdk-cell|k-group-footer|k-group-header|k-footer-template|role\s*=\s*["'](?:row|gridcell|columnheader|rowheader)["']/i;
...
function clipboardHtmlLooksLikeGrid(html) {
 ...
 */
function tokenizeCollapsedReportRow(text) {
 ...
 */
function expandCollapsedTableRows(table) {
...
function tableLooksHorizontallyCollapsed(table, maxCols) {
 ...
 */
function normalizeClipboardHtmlToTable(html) {
...
global.DataCaptureClipboardNormalize = {
