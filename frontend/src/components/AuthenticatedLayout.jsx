    ...
    <>
      ...
      <div className="informationmenu">
        ...
        <div className="informationmenu-content">
          ...
          {(isOwnerOrAdminRole || canAccess("admin")) && (
            <div className="informationmenu-section">
              <div
                className={`informationmenu-section-title ${path === "/admin" ? "current-page" : "account-direct"}`}
                onClick={() => window.location.assign(new URL("/admin", window.location.origin).toString())}
                role="presentation"
              >
                <svg className="section-icon" fill="currentColor" viewBox="0 0 24 24">
