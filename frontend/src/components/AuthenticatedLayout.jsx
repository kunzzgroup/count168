    ...
    <>
      ...
      <div className="informationmenu">
        ...
        <div className="informationmenu-content">
          ...
          {canAccess("process") && <div className="informationmenu-section"><div className={`informationmenu-section-title ${path === "/process-list" || path === "/games-process-list" ? "current-page" : "account-direct"}`} onClick={() => navigate("/process-list")} role="presentation"><svg className="section-icon" fill="currentColor" viewBox="0 0 24 24"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z" /></svg>Process</div></div>}
