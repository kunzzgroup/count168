...
export default function AuthenticatedLayout() {
  ...
  const processHref = me?.company_has_bank && !me?.company_has_gambling ? "bank_process_list.php" : "processlist.php";
