export const LOGIN_I18N = {
  en: {
    admin: "Admin",
    member: "Member",
    loginTenantGroup: "Group",
    loginTenantCompany: "Company",
    loginTenantAuto: "Auto",
    companyPlaceholder: "Company / Group ID",
    companyPlaceholderGroup: "Group ID (e.g. AP, IG)",
    companyPlaceholderCompany: "Company ID (e.g. C168, 95)",
  ...
  zh: {
    ...
    member: "会员",
    loginTenantGroup: "集团",
    loginTenantCompany: "公司",
    loginTenantAuto: "自动",
    companyPlaceholder: "公司 / 集团 ID",
    companyPlaceholderGroup: "集团 ID（如 AP、IG）",
    companyPlaceholderCompany: "公司 ID（如 C168、95）",
