...
export const DATA_CAPTURE_I18N = {
  en: {
    ...
    removeWordHelp: "Press Enter or comma to add a chip. Click the comma list below to select all (e.g. sad,aa,aaa), then Ctrl+C. Saved for this process.",
  ...
  zh: {
    ...
    enterRemark: "输入备注",
    removeWordHelp: "按 Enter 或逗号添加标签。点击下方整串（如 sad,aa,aaa）可选中全部，再 Ctrl+C 复制；会保存在当前 Process。",
