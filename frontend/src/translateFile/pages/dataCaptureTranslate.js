...
export const DATA_CAPTURE_I18N = {
  en: {
    ...
    reset: "Reset",
    deleteRowData: "Delete",
    selectRowToDeleteData:
      "Select one or more rows (A, B, C…) or columns (1, 2, 3…) to delete the data.",
    draftFlushNeedsProcessCurrency: "Select Process and Currency to update the saved draft.",
    tableSize: "Table Size",
    tableSizeRows: "Rows",
    tableSizeColumns: "Columns",
    tableSizeTotalCells: "Total Cells: {rows} × {cols} = {total}",
    tableSizeResetTitle: "Reset table size to 11 × 11",
    apply: "Apply",
    submit: "Submit",
  ...
  zh: {
    ...
    reset: "重置",
    deleteRowData: "删除",
    selectRowToDeleteData: "请先选择一行或多行（A、B、C…）或一列或多列（1、2、3…）以删除数据。",
    draftFlushNeedsProcessCurrency: "请先选择 Process 和 Currency，才能更新已保存的草稿。",
    tableSize: "表格大小",
    tableSizeRows: "行",
    tableSizeColumns: "列",
    tableSizeTotalCells: "总单元格：{rows} × {cols} = {total}",
    tableSizeResetTitle: "重置表格大小为 11 × 11",
    apply: "应用",
    submit: "提交",
    submitting: "提交中...",
    copy: "复制",
...
export function translateDataCaptureMessage(lang, message) {
  ...
  const map = {
    ...
    "Select row(s) to delete row data": "selectRowToDeleteData",
    "Select Process and Currency to update the saved draft": "draftFlushNeedsProcessCurrency",
  };
  const key = map[raw];
