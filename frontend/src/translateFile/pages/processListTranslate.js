...
export const PROCESS_LIST_I18N = {
  en: {
    ...
    removeWordsHelp: "Comma-separated words (e.g. sad,aa,aaa). Select all to copy. Saved for this process.",
  ...
  zh: {
    ...
    removeWordsHelp: "用逗号分隔词语（如 sad,aa,aaa），可全选复制；会保存在当前 Process。",
