...
export const USER_LIST_I18N = {
  en: {
    ...
    editOwnerProfileHint: "Owner has full access by default. You can update name, email, and password here; permissions, accounts, and processes are not configurable.",
    editUser: "Edit User",
    back: "Back",
  ...
  zh: {
    ...
    editOwner: "编辑 Owner",
    editOwnerProfileHint: "Owner 默认拥有全部权限。此处仅可修改姓名、邮箱与密码；权限、账户与流程不可在此配置。",
    editUser: "编辑用户",
    back: "返回",
