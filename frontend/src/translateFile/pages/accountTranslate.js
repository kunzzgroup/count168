...
export const ACCOUNT_I18N = {
  en: {
    ...
    viewTransactionPayment: "Transaction Payment",
    viewTransactionPaymentTitle: "Open Transaction Payment (Show 0 Balance)",
  ...
  zh: {
    ...
    edit: "编辑",
    viewTransactionPayment: "交易付款",
    viewTransactionPaymentTitle: "打开交易付款（显示0余额）",
