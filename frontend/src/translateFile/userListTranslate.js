export const USER_LIST_I18N = {
  en: {
    ...
    selectAccounts: "Choose accounts",
    selectProcesses: "Choose processes",
    accountsSelectedCount: "{count} accounts selected",
    processesSelectedCount: "{count} processes selected",
    accountsNoneSelected: "No accounts selected",
    processesNoneSelected: "No processes selected",
    accountPickerTitle: "Accounts",
    processPickerTitle: "Process",
    accountSearchPlaceholder: "Filter accounts…",
    processSearchPlaceholder: "Filter process…",
    summaryAndMore: "+{count} more — open picker to view all",
  ...
  zh: {
    ...
    selectAccounts: "选择账号",
    selectProcesses: "选择流程",
    accountsSelectedCount: "已选 {count} 个账号",
    processesSelectedCount: "已选 {count} 个流程",
    accountsNoneSelected: "未选择账号",
    processesNoneSelected: "未选择流程",
    accountPickerTitle: "账号",
    processPickerTitle: "流程",
    accountSearchPlaceholder: "筛选账号…",
    processSearchPlaceholder: "筛选流程…",
    summaryAndMore: "还有 {count} 项，点「选择」查看全部",
