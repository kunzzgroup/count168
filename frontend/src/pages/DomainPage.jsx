      ...
      <div className="container">
        ...
        <div className="action-buttons" style={{ marginBottom: 0, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <button className="btn btn-add" onClick={openAddModal}>Add Domain</button>
            ...
            <button
              type="button"
              className="btn btn-fee-settings"
        ...
        {filteredDomains.length > 0 && (
          <div className="pagination-container" id="paginationContainer" style={{ display: "flex" }}>
            <button
