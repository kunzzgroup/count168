export default function ConfirmDeleteModal({ isOpen, onClose, onConfirm, message }) {
  ...
  return (
    <div id="confirmDeleteModal" className="maintenance-modal" style={{ display: "flex" }}>
      <div className="maintenance-confirm-modal-content">
        ...
        <p className="maintenance-confirm-message">{message}</p>
        <div className="maintenance-confirm-actions">
          <button 
            type="button" 
            className="maintenance-btn maintenance-btn-cancel confirm-cancel" 
            onClick={onClose}
          >
            Cancel
          </button>
          <button 
            type="button" 
            className="maintenance-btn maintenance-btn-delete confirm-delete" 
            onClick={onConfirm}
          >
            Delete
          </button>
