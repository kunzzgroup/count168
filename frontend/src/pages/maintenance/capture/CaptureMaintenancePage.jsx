...
function loadScriptOnce(src) {
  return new Promise((resolve, reject) => {
    ...
    const existing = document.querySelector(`script[data-cm-script="${safe}"]`);
    if (existing) {
      resolve();
      return;
    }
...
export default function CaptureMaintenancePage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const companyCode = current?.company_id || "";
  ...
  const bootstrapVanilla = useCallback(async (snap) => {
    ...
    window.__CAPTURE_MAINTENANCE_SPA_MODE = true;
    window.__cmApiHref = (path) => buildApiUrl(String(path || "").replace(/^\//, ""));
    ...
    await injectStylesheet(assetUrl("css/capture_maintenance.css"));
    ...
    await loadScriptOnce(assetUrl("js/capture_maintenance.js"));
    ...
    await window.__initCaptureMaintenancePage?.();
  }, []);
  ...
  useEffect(() => {
    ...
    return () => {
      cancelled = true;
      window.__CAPTURE_MAINTENANCE_SPA_MODE = false;
    };
  ...
  return (
    <div className="container">
        ...
        <div className="maintenance-filters">
          <div className="maintenance-form-group">
            ...
            <div className="custom-select-wrapper">
              ...
              <div className="custom-select-dropdown" id="filter_process_dropdown">
        ...
        <div className="maintenance-filter-row">
          ...
          <div className="maintenance-actions">
            ...
            <label className="maintenance-confirm-delete-label">
              <input type="checkbox" id="confirmDelete" className="maintenance-checkbox" onChange={() => window.toggleDeleteButton?.()} />
          ...
          <thead>
            <tr>
              ...
              <th className="maintenance-select-all-header">
                <input type="checkbox" id="select_all_capture" className="maintenance-checkbox" title="Select All" onChange={(e) => window.toggleSelectAllRows?.(e.target)} />
              </th>
            </tr>
          </thead>
      ...
      <div className="empty-state-container" id="emptyState" style={{ display: "none" }}>
      ...
      <div id="confirmDeleteModal" className="maintenance-modal" style={{ display: "none" }}>
        <div className="maintenance-confirm-modal-content">
          ...
          <p id="confirmDeleteMessage" className="maintenance-confirm-message">This action cannot be undone.</p>
          <div className="maintenance-confirm-actions">
            <button type="button" className="maintenance-btn maintenance-btn-cancel confirm-cancel" onClick={() => window.closeConfirmDeleteModal?.()}>Cancel</button>
            <button type="button" className="maintenance-btn maintenance-btn-delete confirm-delete" onClick={() => window.confirmDelete?.()}>Delete</button>
          </div>
        </div>
      </div>
