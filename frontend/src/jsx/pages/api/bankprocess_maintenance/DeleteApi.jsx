/**
 * Migrated from legacy/api/bankprocess_maintenance/delete_api.php
...
export default function DeleteApi() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "api/bankprocess_maintenance/delete_api.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>DeleteApi</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/api/bankprocess_maintenance/delete_api.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/api/bankprocess_maintenance/delete_api</code>
      </p>
      <hr />
