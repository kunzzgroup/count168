/**
 * Migrated from legacy/api/maintenance/list_api.php
...
export default function ListApi() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "api/maintenance/list_api.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      ...
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/api/maintenance/list_api.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/api/maintenance/list_api</code>
      </p>
      <hr />
