/**
 * Migrated from legacy/api/maintenance/get_public_api.php
...
export default function GetPublicApi() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "api/maintenance/get_public_api.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>GetPublicApi</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/api/maintenance/get_public_api.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/api/maintenance/get_public_api</code>
      </p>
      <hr />
