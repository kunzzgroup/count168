/**
 * Migrated from legacy/api/maintenance/create_api.php
...
export default function CreateApi() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "api/maintenance/create_api.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>CreateApi</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/api/maintenance/create_api.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/api/maintenance/create_api</code>
      </p>
      <hr />
