/**
 * Migrated from legacy/api/processes/billing_schedule.php
...
export default function BillingSchedule() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "api/processes/billing_schedule.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>BillingSchedule</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/api/processes/billing_schedule.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/api/processes/billing_schedule</code>
      </p>
      <hr />
