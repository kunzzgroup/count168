/**
 * Migrated from legacy/api/company/verify_api.php
...
export default function VerifyApi() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "api/company/verify_api.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>VerifyApi</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/api/company/verify_api.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/api/company/verify_api</code>
      </p>
      <hr />
