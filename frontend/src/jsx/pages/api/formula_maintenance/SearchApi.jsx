/**
 * Migrated from legacy/api/formula_maintenance/search_api.php
...
export default function SearchApi() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "api/formula_maintenance/search_api.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      ...
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/api/formula_maintenance/search_api.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/api/formula_maintenance/search_api</code>
      </p>
      <hr />
