/**
 * Migrated from legacy/api/users/userlist_api.php
...
export default function UserlistApi() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "api/users/userlist_api.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>UserlistApi</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/api/users/userlist_api.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/api/users/userlist_api</code>
      </p>
      <hr />
