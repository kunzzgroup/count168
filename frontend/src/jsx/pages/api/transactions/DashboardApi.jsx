/**
 * Migrated from legacy/api/transactions/dashboard_api.php
...
export default function DashboardApi() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "api/transactions/dashboard_api.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>DashboardApi</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/api/transactions/dashboard_api.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/api/transactions/dashboard_api</code>
      </p>
      <hr />
