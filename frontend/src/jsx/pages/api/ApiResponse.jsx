/**
 * Migrated from legacy/api/api_response.php
...
export default function ApiResponse() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "api/api_response.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>ApiResponse</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/api/api_response.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/api/api_response</code>
      </p>
      <hr />
