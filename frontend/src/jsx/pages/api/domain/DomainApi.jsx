...
export default function DomainApi() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "api/domain/domain_api.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>DomainApi</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/api/domain/domain_api.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/api/domain/domain_api</code>
      </p>
      <hr />
