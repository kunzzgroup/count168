/**
 * Migrated from legacy/formula_maintenance.php
 * UI placeholder - replace with full React. Backend: Spring Boot /api/legacy/*
 */
import { useEffect, useState } from "react";
import axios from "axios";

export default function FormulaMaintenance() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "formula_maintenance.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>FormulaMaintenance</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/formula_maintenance.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/formula_maintenance</code>
      </p>
      <hr />
