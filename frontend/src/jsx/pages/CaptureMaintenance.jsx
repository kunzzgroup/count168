/**
 * Migrated from legacy/capture_maintenance.php
 * UI placeholder - replace with full React. Backend: Spring Boot /api/legacy/*
 */
import { useEffect, useState } from "react";
import axios from "axios";

export default function CaptureMaintenance() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "capture_maintenance.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>CaptureMaintenance</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/capture_maintenance.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/capture_maintenance</code>
      </p>
      <hr />
