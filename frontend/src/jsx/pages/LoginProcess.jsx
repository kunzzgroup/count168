/**
 * Migrated from legacy/login_process.php
...
export default function LoginProcess() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "login_process.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>LoginProcess</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/login_process.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/login_process</code>
      </p>
      <hr />
