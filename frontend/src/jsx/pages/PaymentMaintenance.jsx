/**
 * Migrated from legacy/payment_maintenance.php
...
export default function PaymentMaintenance() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "payment_maintenance.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>PaymentMaintenance</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/payment_maintenance.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/payment_maintenance</code>
      </p>
      <hr />
