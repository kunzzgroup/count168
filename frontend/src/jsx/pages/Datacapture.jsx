/**
 * Migrated from legacy/datacapture.php
...
export default function Datacapture() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "datacapture.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>Datacapture</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/datacapture.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/datacapture</code>
      </p>
      <hr />
