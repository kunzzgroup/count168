/**
 * Migrated from legacy/domain.php
...
export default function Domain() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "domain.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>Domain</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/domain.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/domain</code>
      </p>
      <hr />
