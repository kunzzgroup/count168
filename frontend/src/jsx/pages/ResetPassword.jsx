/**
 * Migrated from legacy/reset-password.php
...
export default function ResetPassword() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "reset-password.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>ResetPassword</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/reset-password.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/reset-password</code>
      </p>
      <hr />
