/**
 * Migrated from legacy/add-account.php
...
export default function AddAccount() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "add-account.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>AddAccount</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/add-account.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/add-account</code>
      </p>
      <hr />
