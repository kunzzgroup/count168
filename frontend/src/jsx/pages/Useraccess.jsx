/**
 * Migrated from legacy/useraccess.php
...
export default function Useraccess() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "useraccess.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>Useraccess</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/useraccess.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/useraccess</code>
      </p>
      <hr />
