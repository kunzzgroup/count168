/**
 * Migrated from legacy/domainapi.php
...
export default function Domainapi() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "domainapi.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      ...
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/domainapi.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/domainapi</code>
      </p>
      <hr />
