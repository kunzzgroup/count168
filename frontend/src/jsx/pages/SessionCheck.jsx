/**
 * Migrated from legacy/session_check.php
...
export default function SessionCheck() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "session_check.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>SessionCheck</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/session_check.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/session_check</code>
      </p>
      <hr />
