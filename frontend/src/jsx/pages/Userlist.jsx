/**
 * Migrated from legacy/userlist.php
...
export default function Userlist() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "userlist.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>Userlist</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/userlist.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/userlist</code>
      </p>
      <hr />
