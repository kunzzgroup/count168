/**
 * Migrated from legacy/bank_process_list.php
 * UI placeholder - replace with full React. Backend: Spring Boot /api/legacy/*
 */
import { useEffect, useState } from "react";
import axios from "axios";

export default function BankProcessList() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "bank_process_list.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>BankProcessList</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/bank_process_list.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/bank_process_list</code>
      </p>
      <hr />
