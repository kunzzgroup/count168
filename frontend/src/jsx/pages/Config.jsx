/**
 * Migrated from legacy/config.php
...
export default function Config() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "config.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>Config</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/config.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/config</code>
      </p>
      <hr />
