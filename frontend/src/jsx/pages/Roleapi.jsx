/**
 * Migrated from legacy/roleapi.php
...
export default function Roleapi() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "roleapi.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>Roleapi</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/roleapi.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/roleapi</code>
      </p>
      <hr />
