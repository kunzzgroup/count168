/**
 * Migrated from legacy/sidebar.php
...
export default function Sidebar() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "sidebar.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>Sidebar</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/sidebar.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/sidebar</code>
      </p>
      <hr />
