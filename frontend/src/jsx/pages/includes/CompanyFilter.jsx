/**
 * Migrated from legacy/includes/company_filter.php
...
export default function CompanyFilter() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "includes/company_filter.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>CompanyFilter</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/includes/company_filter.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/includes/company_filter</code>
      </p>
      <hr />
