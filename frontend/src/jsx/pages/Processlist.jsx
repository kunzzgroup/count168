/**
 * Migrated from legacy/processlist.php
...
export default function Processlist() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "processlist.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>Processlist</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/processlist.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/processlist</code>
      </p>
      <hr />
