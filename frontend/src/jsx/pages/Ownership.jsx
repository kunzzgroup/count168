/**
 * Migrated from legacy/ownership.php
...
export default function Ownership() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "ownership.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>Ownership</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/ownership.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/ownership</code>
      </p>
      <hr />
