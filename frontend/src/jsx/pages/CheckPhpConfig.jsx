...
export default function CheckPhpConfig() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "check_php_config.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>CheckPhpConfig</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/check_php_config.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/check_php_config</code>
      </p>
      <hr />
