/**
 * Migrated from legacy/transaction.php
...
export default function Transaction() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "transaction.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>Transaction</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/transaction.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/transaction</code>
      </p>
      <hr />
