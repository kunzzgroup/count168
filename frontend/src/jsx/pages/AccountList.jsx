/**
 * Migrated from legacy/account-list.php
...
export default function AccountList() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "account-list.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>AccountList</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/account-list.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/account-list</code>
      </p>
      <hr />
