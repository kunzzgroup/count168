/**
 * Migrated from legacy/datacapturesummary.php
 * UI placeholder - replace with full React. Backend: Spring Boot /api/legacy/*
 */
import { useEffect, useState } from "react";
import axios from "axios";

export default function Datacapturesummary() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "datacapturesummary.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>Datacapturesummary</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/datacapturesummary.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/datacapturesummary</code>
      </p>
      <hr />
