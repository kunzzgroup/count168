/**
 * Migrated from legacy/announcement.php
...
export default function Announcement() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "announcement.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>Announcement</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/announcement.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/announcement</code>
      </p>
      <hr />
