/**
 * Migrated from legacy/auto_monthly_accounting.php
 * UI placeholder - replace with full React. Backend: Spring Boot /api/legacy/*
 */
import { useEffect, useState } from "react";
import axios from "axios";

export default function AutoMonthlyAccounting() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "auto_monthly_accounting.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>AutoMonthlyAccounting</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/auto_monthly_accounting.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/auto_monthly_accounting</code>
      </p>
      <hr />
