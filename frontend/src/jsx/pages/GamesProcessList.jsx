/**
 * Migrated from legacy/games_process_list.php
 * UI placeholder - replace with full React. Backend: Spring Boot /api/legacy/*
 */
import { useEffect, useState } from "react";
import axios from "axios";

export default function GamesProcessList() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "games_process_list.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>GamesProcessList</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/games_process_list.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/games_process_list</code>
      </p>
      <hr />
