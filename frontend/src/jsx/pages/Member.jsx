/**
 * Migrated from legacy/member.php
...
export default function Member() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "member.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>Member</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/member.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/member</code>
      </p>
      <hr />
