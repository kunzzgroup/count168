/**
 * Migrated from legacy/customer_report.php
...
export default function CustomerReport() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "customer_report.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>CustomerReport</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/customer_report.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/customer_report</code>
      </p>
      <hr />
