...
export default function DebugAg110() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "debug_ag110.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>DebugAg110</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/debug_ag110.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/debug_ag110</code>
      </p>
      <hr />
