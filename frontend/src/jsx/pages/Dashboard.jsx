/**
 * Migrated from legacy/dashboard.php
...
export default function Dashboard() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "dashboard.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      ...
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/dashboard.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/dashboard</code>
      </p>
      <hr />
