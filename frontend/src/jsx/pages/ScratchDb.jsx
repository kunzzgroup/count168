...
export default function ScratchDb() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "scratch_db.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>ScratchDb</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/scratch_db.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/scratch_db</code>
      </p>
      <hr />
