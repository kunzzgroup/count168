/**
 * Migrated from legacy/domain_report.php
...
export default function DomainReport() {
  ...
  useEffect(() => {
    let cancelled = false;
    axios
      .get("/api/legacy/stub", { params: { php: "domain_report.php" } })
  ...
  return (
    <section style={{ padding: "1rem", maxWidth: 960, margin: "0 auto" }}>
      <h1 style={{ fontSize: "1.25rem" }}>DomainReport</h1>
      <p style={{ color: "#555", fontSize: 14 }}>
        Original PHP: <code>legacy/domain_report.php</code>
      </p>
      <p style={{ fontSize: 14 }}>
        React route: <code>/app/domain_report</code>
      </p>
      <hr />
