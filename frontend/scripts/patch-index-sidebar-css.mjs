...
const SCROLLBAR_HREF = "/frontend/dist/css/dashboard-scrollbar.css?v=20260703-sidebar-scroll-v21";
const SIDEBAR_LINK =
  '<link rel="stylesheet" href="/frontend/dist/css/sidebar.css?v=20260703-sidebar-scroll-v21" />';
