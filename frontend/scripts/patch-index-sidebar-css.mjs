...
const SIDEBAR_LINK =
  '<link rel="stylesheet" href="/frontend/dist/css/sidebar.css?v=20260703-sidebar-flyout-v5" />';
const SCROLLBAR_HREF = "/frontend/dist/css/dashboard-scrollbar.css?v=20260703-sidebar-flyout-v5";
