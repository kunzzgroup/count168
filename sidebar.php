...
<div class="informationmenu">
    <div class="informationmenu-header">
        <div class="header-logo-section">
            ...
            <!-- 通知铃铛 -->
            <div class="notification-bell" data-i18n-title="notifications" title="Notifications" onclick="toggleNotificationPanel(event)">
        ...
        <div class="user-info-container">
            ...
            <div class="avatar-selector-container">
                ...
                <div class="avatar-options" id="avatarOptions">
                    <div class="options-title" data-i18n="chooseAvatar">Choose Avatar</div>

                    <!-- 性别选择 -->
                    <div class="gender-selection" id="genderSelection">
                        <button type="button" class="gender-btn active" data-gender="male" data-i18n="male" onclick="selectGender('male')">Male</button>
                        <button type="button" class="gender-btn" data-gender="female" data-i18n="female" onclick="selectGender('female')">Female</button>
                    </div>
        ...
        <?php if ($isMember): ?>
            ...
            <div class="informationmenu-section">
                <div class="informationmenu-section-title account-direct" data-page="member.php"
                    ...
                    <span data-i18n="winLoss">Win/Loss</span>
                </div>
            </div>
        <?php else: ?>
            <!-- Home Section -->
            ...
            <?php if ($hasC168DomainPageAccess): ?>
                <div class="informationmenu-section">
                    <div class="informationmenu-section-title" data-page="domain.php"
                        ...
                        <span data-i18n="domain">Domain</span>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if ($hasC168DomainPageAccess): ?>
                <div class="informationmenu-section">
                    <div class="informationmenu-section-title account-direct" data-page="announcement.php"
                        ...
                        <span data-i18n="announcement">Announcement</span>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if (empty($permissions) || in_array('account', $permissions)): ?>
                ...
                <div class="informationmenu-section">
                    <div class="informationmenu-section-title account-direct" data-page="ownership.php"
                        ...
                        <span data-i18n="ownership">Ownership</span>
                    </div>
                </div>
            ...
            <?php if (empty($permissions) || in_array('datacapture', $permissions)): ?>
                <div class="informationmenu-section" id="sidebar-datacapture-section" <?php echo $companyHasGambling ? '' : ' style="display:none;"'; ?>>
                    <div class="informationmenu-section-title" data-page="datacapture.php"
                        ...
                        <span data-i18n="dataCapture">Data Capture</span>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if (empty($permissions) || in_array('payment', $permissions)): ?>
                <div class="informationmenu-section">
                    <div class="informationmenu-section-title" data-page="transaction.php"
                        ...
                        <span data-i18n="transactionPayment">Transaction Payment</span>
                    </div>
                </div>
            <?php endif; ?>
                        ...
                        <div class="submenu" id="report-submenu">
                            <div class="submenu-content">
                                <a href="customer_report.php" class="submenu-item">
                                    <span data-i18n="customerReport">Customer Report</span>
                                </a>
                                <a href="domain_report.php" class="submenu-item">
                                    <span data-i18n="domainReport">Domain Report</span>
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <div class="informationmenu-footer">
        <?php if ($company_expiration_date): ?>
            <div class="company-expiration-countdown <?php echo $expiration_status; ?>" id="companyExpirationCountdown">
                ...
                <div class="expiration-content">
                    <span class="expiration-label" data-i18n="exp">Exp:</span>
        ...
        <?php endif; ?>
        <button class="btn logout-btn" data-i18n="logout" onclick="handleLogout()">
            Logout
        </button>
    </div>
</div>
...
<div class="notification-panel" id="notificationPanel">
    <div class="notification-header">
        ...
        <button class="notification-close" data-i18n-title="close" onclick="closeNotificationPanel()" title="Close">
...
<script>
    ...
    window.isExternalView = <?php
        ...
        // Domain 页允许 partnership 在 C168 下进行 CRUD，因此不在此页启用只读拦截。
        $useExternalView = $isForcedExternalView || (!$isDomainPage && $isReadOnlyPartner);
        echo $useExternalView ? 'true' : 'false';
    ?>;
