    ...
    <div class="informationmenu-content">
        ...
        <?php if ($isMember): ?>
            ...
            <div class="informationmenu-section">
                <a href="dashboard.php" class="informationmenu-section-title account-direct" data-page="dashboard.php">
            ...
            <!-- Member Win/Loss -->
            <div class="informationmenu-section">
                <a href="member.php" class="informationmenu-section-title account-direct" data-page="member.php">
                    <svg class="section-icon" fill="currentColor" viewBox="0 0 24 24">
        ...
        <?php else: ?>
            ...
            <div class="informationmenu-section">
                <a href="dashboard.php" class="informationmenu-section-title" data-page="dashboard.php">
                    <svg class="section-icon" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/>
                    </svg>
                    Home
            ...
            <div class="informationmenu-section">
                <a href="domain.php" class="informationmenu-section-title" data-page="domain.php">
                    <svg class="section-icon" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="informationmenu-section">
                <a href="announcement.php" class="informationmenu-section-title account-direct" data-page="announcement.php">
                    <svg class="section-icon" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="informationmenu-section">
                <a href="userlist.php" class="informationmenu-section-title account-direct" data-page="userlist.php">
                    <svg class="section-icon" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="informationmenu-section">
                <a href="account-list.php" class="informationmenu-section-title account-direct" data-page="account-list.php">
                    <svg class="section-icon" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="informationmenu-section">
                <a href="processlist.php" class="informationmenu-section-title" data-page="processlist.php">
                    <svg class="section-icon" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="informationmenu-section">
                <a href="datacapture.php" class="informationmenu-section-title" data-page="datacapture.php">
                    <svg class="section-icon" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="informationmenu-section">
                <a href="transaction.php" class="informationmenu-section-title" data-page="transaction.php">
                    <svg class="section-icon" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M20 4H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2zm0 14H4v-6h16v6zm0-10H4V6h16v2z"/>
                    </svg>
                    Transaction Payment
