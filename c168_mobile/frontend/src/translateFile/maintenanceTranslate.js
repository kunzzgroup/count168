...
export const MAINTENANCE_I18N = {
  en: {
    ...
    setupBankFeatures: "List · Status · Due",
    ...
    bankReadOnlyNote: "Edit full forms come next. Status, remark, resend and accounting due are available.",
  ...
  zh: {
    ...
    bankReadOnlyNote: "完整编辑表单后续开放。状态、备注、重送与待入账已可用。",
    bankActionsTitle: "流程",
    bankSaveStatus: "保存状态",
    bankRemark: "备注",
