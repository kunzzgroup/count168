...
export const MAINTENANCE_I18N = {
  en: {
    ...
    setupBankDesc: "Bank process list, filters and status.",
    setupBankFeatures: "List · Filters · Read first",
    ...
    bankReadOnlyNote: "Mobile Bank Process is list + filters for now. Edit / Due come next.",
  ...
  zh: {
    ...
    setupFormula: "公式",
    setupBank: "银行流程",
    setupBankDesc: "银行流程列表、筛选与状态。",
    setupBankFeatures: "列表 · 筛选 · 先只读",
    ...
    bankReadOnlyNote: "手机端银行流程目前为列表 + 筛选。编辑 / 待入账后续开放。",
